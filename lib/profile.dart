            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // Số liệu thực từ AppNotifier
                  Row(
                    children: [
                      _buildStat(
                          '${app.orders.length}', 'Đơn hàng'),
                      _divider(),
                      _buildStat(
                          '${app.favorites.length}', 'Yêu thích'),
                      _divider(),
            ...
            _menuGroup(context, [
              _buildMenuItem(
                ...
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text('Phương thức thanh toán')),
                ),
              ),
              _buildMenuItem(
                context,
...
// Widget nhỏ dùng const constructor cho stat không thay đổi
